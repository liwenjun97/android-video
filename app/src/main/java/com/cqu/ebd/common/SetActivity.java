    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch(item.getItemId()) {
        	case R.id.set_menu:
        	{
        		...
        		if( ts==null||ts==""){Toast.makeText(SetActivity.this, "提示！密码不能为空", Toast.LENGTH_SHORT).show(); break;}
        		
        		int len = ts.length();
        		if(len!=6){Toast.makeText(SetActivity.this, "提示！密码必须为6位数字", Toast.LENGTH_SHORT).show(); break;}
        		Toast.makeText(SetActivity.this, "提示！密码保存成功", Toast.LENGTH_SHORT).show();
